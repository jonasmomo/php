...
?>
  ...
  <h2>Legg deltager til øvelse</h2>
  <?php 
  echo '<form name="form1" method="post" action="registrerovelsedeltager.php">';
    
      echo '<select name="person">';
          $myData = mysql_query("SELECT idPerson, fornavn, etternavn from person WHERE persontype=1");
